...
const registrationData = computed(() => {
  return {
    ...
    open_for_application: props.data?.field_open_for_application,
  };
});
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="internship__tags-wrapper">
              ...
              <div class="internship__tags-item" v-if="data?.field_open_for_application">
                <BaseTag
                  :data="{ label: 'Åben for ansøgning' }"
                  color="secondary-lighten"
                />
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div
          v-if="
            ...
            data.field_application_phone ||
            data.field_application_url ||
            data.field_open_for_application ||
            !data.field_open_for_application ||
